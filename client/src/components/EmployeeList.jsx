...
const EmployeeList = () => {
    ...
    const fetchEmployees = useCallback(async () => {
        try {
            ...
            setError(null);
            const params = {
                page: currentPage, limit: employeesPerPage, search: searchTerm, sortField, sortOrder,
            };
    ...
    }, [currentPage, employeesPerPage, sortField, searchTerm, sortOrder]);
    ...
    return (<div className="overflow-x-auto">
        ...
        {error && (<div className="mb-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">
            <span className="block sm:inline">{error}</span>
        </div>)}

        {loading ? (<div className="flex justify-center items-center h-64">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500"></div>
        </div>) : employees.length === 0 ? (<div className="text-center text-gray-500 my-8">
            <p>No employees found</p>
        </div>) : (<div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <div className="flex justify-between items-center mb-4">
                <div>
                    ...
                    <button onClick={handleSearch}
                            className="text-white m-3 bg-blue-400 hover:bg-blue-500 px-3 py-2 rounded-md text-sm font-medium transition-colors">Search
                    </button>
                </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Create
                        Date
                    </th>
                ...
                {employees.map((employee) => (<tr key={employee._id}
                                                  className={`hover:bg-gray-50 ${!employee.active ? 'opacity-50' : ''}`}>
